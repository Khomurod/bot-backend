...
const CAPABILITIES = Object.freeze([
  ...
  {
    key: 'dispatch_rate_confirmation',
    label: 'Parse a rate confirmation',
    what: 'Turns a rate confirmation image or PDF into the dispatch template.',
    group: 'Dispatch',
    changesState: false,
    sendsRawText: true,
    fallback: 'Parsing stops and says so; nothing is guessed.',
  },
  {
