...
const CATEGORIES = Object.freeze([
  ...
  },
  {
    ...
    what: 'A money-code document Wenze could not read with enough certainty for a person to '
      + 'rely on, or a finance report that failed to send. Never the money code itself.',
    severity: 'warning',
    humanActionUsually: true,
  },
  {
