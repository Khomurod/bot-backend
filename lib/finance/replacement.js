...
function classifyReplacementLanguage(text) {
  ...
  // Labelled references and amounts are not candidate codes — see
  // `namedCodesIn`. Scanning them made a replacement reply in the real EFS
  // format name a code nobody holds, and refuse a conclusive reply.
