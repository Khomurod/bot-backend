...
const { findUnitByTruckNumber } = require('../services/evoEldService');

test('findUnitByTruckNumber matches normalized truck numbers', () => {
  const units = [
...
test('findUnitByTruckNumber returns newest unit when duplicates exist', () => {
  const units = [
...
test('findUnitByTruckNumber returns null when no match exists', () => {
