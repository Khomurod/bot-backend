...
# Hardcoded default so this no longer needs to live in the Render environment.
TELEGRAM_CHAT_ID: str = os.environ.get("TELEGRAM_CHAT_ID", "-5231255301")
...
RC_FROM_NUMBER: str = os.environ.get("RC_FROM_NUMBER", "+14704804679")
